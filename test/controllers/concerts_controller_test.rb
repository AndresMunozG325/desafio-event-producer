...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { Group_id: @concert.Group_id, concert_date: @concert.concert_date, concert_name: @concert.concert_name, duration: @concert.duration, number_of_people: @concert.number_of_people } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { Group_id: @concert.Group_id, concert_date: @concert.concert_date, concert_name: @concert.concert_name, duration: @concert.duration, number_of_people: @concert.number_of_people } }
